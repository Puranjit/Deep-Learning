# -*- coding: utf-8 -*-
"""
Created on Fri Mar 25 00:33:31 2022
...
# using the pre-trained weights as it is and not updating them during training phase
...
plt.savefig('LossVal_lossR50FineTune')
plt.show()
...
plt.legend()
plt.savefig('AccVal_accR50FineTune')
plt.show()
